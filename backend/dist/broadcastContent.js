...
exports.buildBroadcastEmailHtml = buildBroadcastEmailHtml;
exports.plainTextToHtml = plainTextToHtml;
exports.buildBroadcastEmailPlainText = buildBroadcastEmailPlainText;
const env_1 = require("./env");
const TEAM_NAME = 'The Blue Wave Fans Team';
function buildBroadcastEmailHtml(subject, messageHtml, siteUrl) {
    const site = (siteUrl || (0, env_1.getSiteUrl)()).replace(/\/$/, '');
...
function buildBroadcastEmailPlainText(subject, message, siteUrl) {
    const site = (siteUrl || (0, env_1.getSiteUrl)()).replace(/\/$/, '');
    return [
        subject,
        '',
